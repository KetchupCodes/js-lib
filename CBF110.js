...
class UnifiedModule {
  ...
  createChatbotIframe() {
    ...
    if (!element) {
      ...
      style.innerHTML = `
        #chatbot-container {
          position: -${this.chatbotOptions.defaultWidth}rem;
          right: -px; /* Initially position the container off-screen to the right */
          bottom: 5px;
          ...
          transition: right 5s ease-in-out; /* Add a transition for the right property */
        }
